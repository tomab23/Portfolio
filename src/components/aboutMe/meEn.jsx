...
const MeEn = () => {
  return (
    // EN
    <div>
    <p>My name is <b></b> after discovering development in May 2022 for 5 weeks, I went on a training course for <b> Application Designer and Developer</b> for 8 months.</p>
      <br />
