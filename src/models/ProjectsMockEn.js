...
export const ProjectsMockEn = [
    {
        id: 1,
        name: "test_un",
        resume: "Welcome on the project 1",
        img: img1,
    ...
    },
    {
        id: 2,
        name: "test_deux",
        resume: "Welcome on the project 2",
        img: img4,
        tech: ["React", "Java", "MySql"],
    ...
    },
    {
        id: 3,
        name: "test_trois",
        resume: "Welcome on the project 3",
        img: img6,
        tech: ["React", "Java", "MySql"],
    ...
    },
    {
        id: 4,
        name: "test_4",
        resume: "Welcome on the project 4",
        img: img6,
        tech: ["React", "Java", "MySql"],
    ...
    },
    {
        id: 5,
        name: "test_5",
        resume: "Welcome on the project 5",
        img: img6,
        tech: ["React", "Java", "MySql"],
